...
Interner *get_global_interner() { return &global_interner; }

StrId get_strid_true() { return strid_true; }

StrId get_strid_false() { return strid_false; }

StrId get_strid_empty() { return strid_empty; }
